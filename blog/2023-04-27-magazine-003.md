...
Check out the Wing [research](https://github.com/winglang/research/tree/main/dogfooding) repo to see the project's source code, or join our [Slack](https://t.winglang.io/slack) to get notified when we announce the next Wingathon.
