...
Welcome to the **Wing Inflight Magazine**, our period update on what's up (yes,
two puns) with the Wing programming language and the community that's starting
to take shape around the mission to reshape cloud development.
...
- [RFC: Wing SDK spec](#requesting-comments-on-our-sdk-specification) - your
  ...
  in the Wing SDK.
- [RFC: sing Terraform resources in Wing](#rfc-using-terraform-resources-in-wing)
...
out our very early alpha bits and initial [documentation].

We published our [manifesto for cloud-oriented programming] which describes the
background for our project. It talks about the current challenges that
...
to [winglang.io], with tons of interesting feedback and relevant conversations:
...
[manifesto for cloud-oriented programming]: https://docs.winglang.io/blog/2022/11/23/manifesto
...
initial [Wing Language Specification]. The spec currently includes the minimal
set of features we believe are required to build cloud applications with Wing.

We recently added support for `while` loops ([#312]) and basic `enum`
declarations ([#273]).
...
[#977] on giving enums Algebraic super-powers, with similar capabilities that
exist in Rust and Swift.

Check out the **Wing Language Roadmap** in the Wing GitHub repository for an
up-to-date status.

[#312]: https://github.com/winglang/wing/pull/312
[#273]: https://github.com/winglang/wing/pull/273
[#977]: https://github.com/winglang/wing/issues/977
...
To see what this work will enable, check out this [user story](https://github.com/winglang/wing/blob/4ac4f0985702f092719f97760c99249757e6dba4/rfcs/epic-todo-app-compiler.md).
...
pointing Wing Console directly at a `.w` source file. The console will take of
