...
(yes, two puns) with the [Wing Programming Language](https://winglang.io), and the community that's 
starting to gather around the mission to reshape
cloud development.
...
We are [@winglangio](https://twitter.com/winglangio)
on Twitter, and we hang out 24/7
on [Wing Slack](https://t.winglang.io/slack).
