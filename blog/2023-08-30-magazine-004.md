...
🚀 [Integrated Console in VSCode:](#intergrated-console-in-vscode)
...
![inference-closure-arguments](./assets/inference-closure-arguments.png)
...
Thanks again to all our amazing contributors: x,x,x,x,x,
