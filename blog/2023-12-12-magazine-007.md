...
Get your hands dirty with [Eyal Keren](https://github.com/ekeren) as we build together an
application that allows you to load any PDF file and ask questions about it using one of [Amazon
