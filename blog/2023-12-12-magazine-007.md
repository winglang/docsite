...
- 🚀 [New: Use Typescript with Wing CLI](#typescript-is-coming)
...
### TypeScript is coming...

So far, taking flight with Wing (ha ha) was only possible from this awesome new programming language
called Winglang, but soon, you'll be able to enjoy many of the benefits of the Wing framework from
the comforts of JavaScript and TypeScript.

As a first step, it is now possible to write Wing programs in TypeScript and run them using the Wing
CLI.

First, install `ts4w` (temporary name) which includes some utility functions for Wing:

```sh
npm i ts4w
```

Now, create a `main.ts` file:
...
This will open up [Wing Console](https://www.winglang.io/docs/tools/wing-console) with your program.

The next step is to enable consuming [winglibs](https://github.com/winglang/winglibs) such as
[websockets](https://github.com/winglang/winglibs/tree/main/websockets) from TypeScript. Stay tuned
and let us know what you think!

❤️ [Mark McCulloh](https://github.com/MarkMcCulloh)
...
- [Amazon Bedrock + Winglang Workshop](TBD): In the workshop, Eyal shows how to implement a GitHub bot from zero to hero using Amazon Bedrock & Winglang.
...
You'll find us regularly on [Slack](https://t.winglang.io/slack), so feel free to say hello! Give
