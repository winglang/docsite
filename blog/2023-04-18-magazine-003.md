...
Extern code is necessarily unsafe -- Wing doesn't guarantee that your type signature is correct, or that the function will behave the same way in the simulator as it does in the cloud.
But it's a great way to reuse existing code and libraries in Wing apps, and we're excited to see what you build with it!
