            ...
            {features.map((feature) => (
              <div key={feature.name} className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-lg leading-7 text-gray-300 ml-0 ">
                  <p className="flex-auto text-lg text-gray-800 dark:text-gray-400">{feature.description}</p>
                  <p className="mt-3">
                    <a href={feature.href} className="text-md font-semibold leading-6 text-teal-700 dark:text-wing">
