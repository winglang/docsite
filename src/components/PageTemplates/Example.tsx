                ...
                <div className="lg:grid lg:grid-cols-3 xl:grid-cols-4">
                    <div className="lg:col-span-2 lg:mt-0 xl:col-span-3 w-full lg:pr-20  ">
                        <section className=''>
                            <div className='gray-spacer mb-6 pb-2'>
                                <h1 className="text-5xl font-bold tracking-tight text-gray-900 dark:text-gray-100 m-0 p-0">{example.title}</h1>
                            ...
                            <div className="prose prose-md prose-invert text-gray-800 dark:text-gray-100">
                              
                                <h3 className='text-gray-800 dark:text-gray-200'>{example.subtitle}</h3>
                                {renderCoverImage &&
                                ...
                                <Markdown
                                    ...
                                    components={{
                                        ...
                                        strong: (props) => {
                                            return <strong className='text-gray-800 dark:text-gray-200'>{props.children}</strong>
                                        },
                                        // Used a tip
                                        blockquote: (props) => {
                    ...
                    <aside className="lg:px-4 space-y-6 lg:pt-8 pt-4">
                            ...
                            <div className='space-y-2 gray-spacer pb-8'>
                                ...
                                <ul className='list-none p-0 text-sm space-y-1'>
                                    {example.resources.map((resource, index) => (
                                        <li key={index}>
                                            <Link to={resource.href} className='dark:text-wing text-wing-light'>{resource.label}</Link>
                                        </li>
                                    ))}
                                </ul>
                            </div>
                        ...
                        <div className='space-y-2 '>
                            ...
                            <p className=' text-sm text-gray-800 dark:text-gray-200'>Got a question about this example? <br /> <a className='dark:text-wing text-wing-light mt-1 block' href="">Join us on Discord &rarr;</a></p>
                        </div>
